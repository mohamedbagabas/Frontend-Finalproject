      ...
      <Box
        ...
        <Box
          ...
          <Text
            ...
            color='wi'
            fontSize="lg">
            Your website is the first impression for prospects and owners. And nobody can offer the range of options and technologically advanced capabilities like Propertyware. Simply choose a website design from our library of clean, modern templates and we’ll do the rest. Each option is engaging, customizable, mobile-responsive and easy-to-navigate, featuring prominent contact information.
          </Text >
